/* ============================================================
   projects.js — Loads from Cloudinary via API, no fallback
============================================================ */
const Projects = (() => {
  ...
  async function load() {
    const g = grid();
    if (g) g.innerHTML = '<div style="grid-column:1/-1;text-align:center;padding:60px;color:#94a3b8;font-size:.85rem;letter-spacing:.1em;font-family:\'Barlow Condensed\',sans-serif;text-transform:uppercase;">Loading projects…</div>';
    try {
